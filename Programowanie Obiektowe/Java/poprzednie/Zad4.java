...
class Node extends Expression{
    ...
    abstract class Functor
    {
        ...
        public abstract Expression derivate(Expression a, Expression b);
    ...
    class Multiply extends Functor{
        ...
        public Expression derivate(Expression a, Expression b){
            return new Node('+',new Node('*',a,b.derivate()),new Node('*',a.derivate(),b));
        }
    }
    class Add extends Functor{
        ...
        public Expression derivate(Expression a, Expression b){
            return new Node('+',a.derivate(),b.derivate());
        }
    }
    ...
    class Divide extends Functor{
        ...
        public Expression derivate(Expression a, Expression b){
            return new Node('/',
                        new Node('-',new Node('*',b,a.derivate()),new Node('*',a,b.derivate())),
                        new Node('*',b,b));
        }
    }
    ...
    public Expression derivate(){
        return this.function.derivate(this.left,this.right);
    }
...
public class Zad4{
    public static void main(String [] args){
        ...
        System.out.println("Derivative 1: " + expr1.derivate().toString());
        ...
        System.out.println("Derivative 2: " + expr2.derivate().toString());
        ...
        System.out.println("Derivative: " + expr.derivate().toString());
